...
final public class Contact : GeneratedMessage {
    ...
    override public func getDescription(indent:String) throws -> String {
        ...
        if hasTwitterName {
            output += "\(indent) twitterName: \(String(describing: twitterName)) \n"
        }
        if hasEmail {
            output += "\(indent) email: \(String(describing: email)) \n"
        }
        if hasGithubLink {
            output += "\(indent) githubLink: \(String(describing: githubLink)) \n"
        }
        if (hasType) {
            output += "\(indent) type: \(type.description)\n"
        }
        if hasImageName {
            output += "\(indent) imageName: \(String(describing: imageName)) \n"
        }
